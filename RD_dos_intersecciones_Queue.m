...
s1 = [100 200 100 200]; %valores de saturacion de las calles
Cola_Actual_1 = [0 0 0 0];
x1 = x10;

x20 = (tiempoCiclo/4)*[1 1 1 1]; %tiempos iniciales para semaforos
%s2 = [379 364 52.5 383]; %valores de saturacion de las calles
s2 = [100 200 100 100]; %valores de saturacion de las calles
Cola_Actual_2 = [0 0 0 0];
x2 = x20;
...
%  end
 ...
 % ASIGNACION ESTADOS INTERSECCION 1 
   ...
   % ASIGNACION ESTADOS INTERSECCION 2 
     ...
     if contador == tiempoCiclo-1 % Si ya se cumple el ciclo, se mide colas y se reinicia "contador"
         
         %INTERSECCION 1 COLAS
         ...
         [t1,x1] = ode23s('replicator_equation',Tspan,x10,[],Cola_Actual_1,s1,tiempoCiclo);
         disp('Interseccion 1:');
         disp(x1(end,:));
         
         [t2,x2] = ode23s('replicator_equation',Tspan,x20,[],Cola_Actual_2,s2,tiempoCiclo);
         disp('Interseccion 2:');
         disp(x2(end,:));
